...
func PortFromDomain(port domain.Port) v16.ContainerPortApplyConfiguration {
...
func PortsFromDomain(domainPorts []domain.Port) []v16.ContainerPortApplyConfiguration {
